...
<p key="ap-p-6sixim" className="text-[10px] text-red-500 mt-1 font-semibold">⚠ No rooms are currently available for booking at this branch.</p>
                    )}
                  </div>
...
<div key="ap-div-2w10e" className="mt-3 p-3 bg-amber-50/50 dark:bg-amber-950/30 rounded-xl border border-amber-200 dark:border-amber-800/50 space-y-1.5">
...
<div key="ap-div-cynvy" className="mt-3 p-3 bg-blue-50/50 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-800/50 space-y-2">
...
<div key="ap-div-5098xi" className="mt-3">
                ...
                <div className="relative">
                  ...
                  {showCalendarPopover && (
<div key="ap-div-azcbn" className="fixed inset-0 z-50 flex items-center justify-center pointer-events-auto">
