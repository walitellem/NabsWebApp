        ...
        <div className="max-w-7xl mx-auto w-full mb-6">
          <div className="neu-raised-lg p-6">
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              {(['All', 'Active', 'Pending Review', 'Checked-In', 'No Show', 'Completed'] as const).map((st, idx) => (
                <button
...
<div key="ap-div-ddfeuf" className="flex flex-col sm:flex-row justify-between items-start gap-4 pb-6 border-b border-zinc-200 print:flex-row print:items-center print:gap-4 print:pb-2 print:border-b-dashed print:border-zinc-300">
...
<div key="ap-div-2d9jgd" className="text-zinc-400 text-xs print:text-[10px]">Processed by: {invoiceBooking.receptionistName} (Staff ID: {invoiceBooking.receptionistId})</div>
                              )}
                            </div>
                          </div>
                          <div>
