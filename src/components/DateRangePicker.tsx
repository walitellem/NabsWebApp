        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-1">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className={`block w-full pl-10 pr-3 py-2 text-xs rounded-xl focus:outline-none transition-all ${
                isDarkMode 
                  ? 'neu-inset text-white focus:ring-1 focus:ring-blue-500' 
                  : 'bg-slate-50 border border-slate-200 text-slate-800 focus:border-slate-300'
              }`}
            ...
            <span className={`absolute right-3 top-[-7px] px-1 text-[9px] font-mono uppercase font-bold tracking-wider ${
              isDarkMode ? 'neu-inset text-blue-400' : 'bg-white text-slate-400'
            }`}>
              From Date
            </span>
          </div>
